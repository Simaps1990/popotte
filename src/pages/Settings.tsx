      ...
      <div className="space-y-6 max-w-2xl mx-auto">
        ...
        {activeTab === 'profile' ? (
          <form onSubmit={handleProfileSubmit} className="bg-white p-6 rounded-lg shadow-md mb-6">
            <h2 className="text-xl font-semibold mb-4" style={{ color: '#10182a' }}>Mon profil</h2>
            <div className="mb-4">
            ...
            <button type="submit" className="bg-blue-700 text-white px-4 py-2 rounded hover:bg-blue-800">Enregistrer</button>
          </form>
        ) : (
          <>
